...
Reference full template: `/home/rkujawa/repos/uiscsi/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/rkujawa/repos/uiscsi/.claude/get-shit-done/templates/state.md`.
